	...
	cout << ">>>> Press ESC for to escape" << endl;
		...
		while (1) {
            ...
            if (colorMap != -1) {
                ...
                imwrite("/home/sensable/Documents/flir-modified/BosonUSB2/camera_capture/coloredimg.tiff", coloredFrame);
                ...
                //saving video
                // video.write(frame);
                imwrite("/home/sensable/Documents/flir-modified/BosonUSB2/camera_capture/img.tiff", frame);
